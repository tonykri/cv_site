...
export default function ContactUniForm() {
    ...
    async function handleSubmit(e: any) {
        ...
        axios.post(`http://localhost:8080/contact/university`, {
            "content": content
        }, {
            headers: {
...
return (
    <div className="w-full h-full justify-center items-center">
        <h1 className="text-4xl mt-4 text-center">Contact University</h1>
            ...
            <form onSubmit={handleSubmit} className="">
                ...
                <div className="mb-6">
                    <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                        Content:
                        <textarea rows={10} id="email" className={cssUnit} value={content} onChange={(e) => setContent(e.target.value)} required />
                    </label>
                </div>

                <div className="mb-6 flex justify-start">
                    <button type="submit" className="text-white bg-blue-600 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-1/2 sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Send Request</button>
                </div>
